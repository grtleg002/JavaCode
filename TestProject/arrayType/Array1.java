...
public class Array1 {
	...
	public static void main(String[] args) {
		...
		//배열 변수에 저장된 값 출력
		System.out.println(a); //출력값: [I@2ff4acd0, 실제 주소가 아닌 16진수로 구성된 내부 가상주소
		//[I@2ff4acd0 : 맨앞[ -> 1차원 배열이라는 뜻, I-> int 뜻함, @뒤부터는 16진수 가상주소
		...
		//배열 선언, 할당, 배열 크기 설정과 값 저장 -> 배열 값을 초기화 {}하면서 크기 명시하면 오류
